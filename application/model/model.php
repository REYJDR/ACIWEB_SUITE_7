...
$query ='SELECT * 
            ...
            ITEMS_NO_LOTES.ID_compania = "'.$this->id_compania.'"  AND  STOCK_ITEMS_LOCATION.ID_compania = "'.$this->id_compania.'" 
...
public function Get_SO_NoDes(){
    ...
    $order = $this->Query_value('SalesOrder_Header_Imp','SalesOrderNumber','where ID_compania="'.$this->id_compania.'" and SalesOrderNumber like "ACI-%" ORDER BY ID DESC LIMIT 1');
...
SalesOrder_Detail_Imp.ID_compania="'.$id_compania.'" and SalesOrder_Header_Imp.ID_compania="'.$id_compania.'" and Customers_Exp.id_compania="'.$id_compania.'" 
...
REQ_DETAIL.CANTIDAD,
REQ_DETAIL.CCOST,
REQ_DETAIL.DESCRIPCION,
REQ_DETAIL.ID_compania,
REQ_DETAIL.ITEM_UNIQUE_NO,
REQ_DETAIL.JOB,
sum(REQ_DETAIL.Netdue),
REQ_DETAIL.NO_REQ,
REQ_DETAIL.PHASE,
REQ_DETAIL.ProductID,
REQ_DETAIL.UNIDAD,
REQ_HEADER.USER,
REQ_HEADER.st_closed,
REQ_HEADER.NOTA,
REQ_HEADER.NO_REQ,
REQ_HEADER.LAST_CHANGE,
REQ_HEADER.ID_compania,
REQ_HEADER.ID,
REQ_HEADER.desc_closed,
REQ_HEADER.DATE
FROM `REQ_HEADER` 
inner join REQ_DETAIL ON REQ_HEADER.NO_REQ = REQ_DETAIL.NO_REQ
'.$clause.' group by GROUP BY REQ_DETAIL.CANTIDAD,
REQ_DETAIL.CCOST,
REQ_DETAIL.DESCRIPCION,
REQ_DETAIL.ITEM_UNIQUE_NO,
REQ_DETAIL.JOB,
