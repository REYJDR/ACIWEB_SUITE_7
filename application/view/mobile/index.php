...
<link rel="manifest" href="<?php echo URL; ?>mobile_assets/manifest.json">
<link rel="apple-touch-icon" href="<?php echo URL; ?>mobile_assets/images/apcon_icono.png" />
<link href="<?php echo URL; ?>mobile_assets/images/apple-touch-startup-image-320x460.png" media="(device-width: 320px)" rel="apple-touch-startup-image">
<link href="<?php echo URL; ?>mobile_assets/images/apple-touch-startup-image-640x920.png" media="(device-width: 320px) and (-webkit-device-pixel-ratio: 2)" rel="apple-touch-startup-image">   
<link rel="stylesheet" href="<?php echo URL; ?>mobile_assets/css/framework7.css">
<link rel="stylesheet" href="<?php echo URL; ?>mobile_assets/style.css">
<link rel="stylesheet" href="<?php echo URL; ?>mobile_assets/css/custom.css">
<link href="https://use.fontawesome.com/releases/v5.0.8/css/all.css" rel="stylesheet">
<link type="text/css" rel="stylesheet" href="<?php echo URL; ?>mobile_assets/css/swipebox.css" />
<link type="text/css" rel="stylesheet" href="<?php echo URL; ?>mobile_assets/css/animations.css" />
...
<!-- GENERAL JS -->
<script type="text/javascript" src="<?php echo URL; ?>mobile_assets/js/jquery-1.10.1.min.js"></script>
<script type="text/javascript" src="<?php echo URL; ?>mobile_assets/js/jquery.validate.min.js" ></script>
...
<!-- <div class="info_popup">
	<div class="close_info_popup"><img src="<?php echo URL; ?>mobile_assets/images/icons/white/menu_close.png" alt="" title="" /></div>
...
<input type="hidden" id="active_user_id" value="<?php echo $this->model->active_user_id; ?>" />
	...
	<div class="pages">
		<div data-page="panel-leftmenu" class="page pagepanel">	
         ...
         <div class="page-content">
			...
			<ul>
            <li><a href="#" data-popup=".popup-login" class="open-popup close-panel"><img src="<?php echo URL; ?>mobile_assets/images/icons/white/lock.png" alt="" title="" /><span>Login</span></a></li>
            <li><a href="form.html" class="close-panel" data-view=".view-main"><img src="<?php echo URL; ?>mobile_assets/images/icons/white/form.png" alt="" title="" /><span>Sales Order</span></a></li>
            <li><a href="team.html" class="close-panel" data-view=".view-main"><img src="<?php echo URL; ?>mobile_assets/images/icons/green/search.png" alt="" title="" /><span>Search</span></a></li>
    ...
    <div class="panel panel-right panel-reveal">
      <div class="user_login_info">
                ...
                <img  src="<?php echo URL; ?>mobile_assets/images/user/logo_aci.png" alt="" title="" />
                  ...
                  <nav class="user-nav">
                    ...
                    <!--<li><a href="features.html" class="close-panel"><img src="images/icons/white/settings.png" alt="" title="" /><span>Account Settings</span></a></li> -->
                      <li><a href="<?php echo URL; ?>index.php?url=home/mob_account/<?php echo $this->model->active_user_id; ?>" class="close-panel"><img src="<?php echo URL; ?>mobile_assets/images/icons/white/briefcase.png" alt="" title="" /><span>Perfil</span></a></li>
                    <!--<li><a href="features.html" class="close-panel"><img src="images/icons/white/message.png" alt="" title="" /><span>Messages</span><strong>12</strong></a></li>
                      ...
                      <li><a  onclick='javascript: logout(<?php echo '"'.URL.'"'; ?>);' href="#" class="close-panel"><img src="<?php echo URL; ?>mobile_assets/images/icons/white/lock.png" alt="" title="" /><span>Salir</span></a></li>
                    </ul>
                  </nav>
      </div>
    </div>
            ...
            <div class="page-content">
                        ...
                        <div class="navbarpages">
                            <div class="navbar_left">
                                <div class="logo_text"><a href="index.html"><img width="30" height="30" src="<?php echo URL; ?>mobile_assets/images/apcon_icon.ico" /></a></div>
                            </div>
        ...
        <!-- <div class="navbar_right navbar_right_menu">
             ...
             <div class="swiper-container slidertoolbar swiper-init" data-effect="slide" data-parallax="true" data-pagination=".swiper-pagination"  data-next-button=".swiper-button-next" data-prev-button=".swiper-button-prev">
                    <div class="swiper-wrapper">
                      ...
                      <?php 
                          $dir    = 'mobile_assets/images/slider/';;
                          $images = scandir($dir);
                          ...
                          foreach($images as $slide){
                            ...
                            echo '<div class="swiper-slide" style="background-image:url(mobile_assets/images/slider/'.$slide.');">
		 ...
		 <div class="swiper-container-toolbar swiper-toolbar swiper-init" data-effect="slide" data-slides-per-view="1" data-slides-per-group="1" data-space-between="0" data-pagination=".swiper-pagination-toolbar">
			...
			<div class="swiper-wrapper">
              ...
              <?php if($this->model->verify_session() != '0'){ ?>
                ...
                <a href="#" data-popup=".popup-login" class="open-popup"><img src="<?php echo URL; ?>mobile_assets/images/icons/green/lock.png" alt="" title="" /><span>LOGIN</span></a>
                
              <?php }else{ ?>

                <a href="<?php echo URL; ?>index.php?url=ges_ventas/mob_orden_ventas" data-view=".view-main"><img src="<?php echo URL; ?>mobile_assets/images/icons/green/form.png" alt="" title="" /><span>Pedidos</span></a>
                <a href="<?php echo URL; ?>index.php?url=ges_reportes/rep_so" data-view=".view-main"><img src="<?php echo URL; ?>mobile_assets/images/icons/green/search.png" alt="" title="" /><span>Historial</span></a>
    ...
    <div class="popup popup-login">
        <div class="content-block">
            ...
            <div class="close_popup_button">
                <a href="#" class="close-popup"><img src="<?php echo URL; ?>mobile_assets/images/icons/black/menu_close.png" alt="" title="" /></a>
            </div>
        </div>
    </div>
    ...
    <!--<div class="popup popup-signup">
		...
		<div class="signup_social">
            ...
            <div class="close_popup_button">
                <a href="#" class="close-popup"><img src="mobile_assets/images/icons/black/menu_close.png" alt="" title="" /></a>
            </div>
        </div>
    </div>-->
    ...
    <div class="content-block">
      ...
      <li><a href="http://twitter.com/" class="external"><img src="mobile_assets/images/icons/black/twitter.png" alt="" title="" /><span>TWITTER</span></a></li>
      <li><a href="http://www.facebook.com/" class="external"><img src="mobile_assets/images/icons/black/facebook.png" alt="" title="" /><span>FACEBOOK</span></a></li>
      <li><a href="http://plus.google.com" class="external"><img src="mobile_assets/images/icons/black/gplus.png" alt="" title="" /><span>GOOGLE</span></a></li>
      <li><a href="http://www.dribbble.com/" class="external"><img src="mobile_assets/images/icons/black/dribbble.png" alt="" title="" /><span>DRIBBBLE</span></a></li>
      <li><a href="http://www.linkedin.com/" class="external"><img src="mobile_assets/images/icons/black/linkedin.png" alt="" title="" /><span>LINKEDIN</span></a></li>
      <li><a href="http://www.pinterest.com/" class="external"><img src="mobile_assets/images/icons/black/pinterest.png" alt="" title="" /><span>PINTEREST</span></a></li>
      </ul>
...
<!-- GENERAL JS -->
<script type="text/javascript" src="<?php echo URL; ?>mobile_assets/js/framework7.js"></script>
<script type="text/javascript" src="<?php echo URL; ?>mobile_assets/js/jquery.swipebox.js"></script>
<script type="text/javascript" src="<?php echo URL; ?>mobile_assets/js/jquery.fitvids.js"></script>
<script type="text/javascript" src="<?php echo URL; ?>mobile_assets/js/email.js"></script>
<script type="text/javascript" src="<?php echo URL; ?>mobile_assets/js/audio.min.js"></script>
<script type="text/javascript" src="<?php echo URL; ?>mobile_assets/js/my-app.js"></script>
