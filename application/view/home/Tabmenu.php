...
<fieldset class="fieldsetform">
    <table class='table_form' >
        <tbody>
            ...
            <tr><th><button class="tablinks" onclick="javascript: window.location.href = '<?php echo URL_CUSTOMER; ?>/ACIWEB-opencart/upload/admin';"><i class="fab fa-opencart fa-2x icon-color-dash" > </i>&nbsp&nbsp<?php echo $dash_menu_9; ?></a></th></tr>
