...
<fieldset class="fieldsetform">
    <table class='table_form' >
        <tbody>
            ...
            <tr><th><button class="tablinks" onclick="javascript: window.location.href = '<?php echo $this->model->query_value('API_OPENCART_KEYS','url', 'where id=1'); ?>/admin';"><i class="fab fa-opencart fa-2x icon-color-dash" > </i>&nbsp&nbsp<?php echo $dash_menu_9; ?></a></th></tr>
