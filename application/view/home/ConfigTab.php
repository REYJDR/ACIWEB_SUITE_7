		...
		<div class="col-lg-6" >
			...
			<h4><?php echo $config_28_title; ?></h4> 
					<table class="table_form">
						...
						<tr><th><strong><?php echo $config_30; ?></strong></th><td>REQ-<input type="number" name="req_conse" <?php echo  $req_conse; ?> /></td></tr>
...
<div id="Config12" class="tabcontent">
    ...
    <fieldset class="fieldsetform"  >
	  ...
	  <div class='col-lg-3'>
        <button onclick="location.replace('<?php echo $oc_url; ?>/admin')" class="dashBottom" ><i class="fab fa-opencart fa-2x icon-color-dash" ></i><br>Administrar tienda</button>
	  </div>
	   ...
	   <input type="hidden"  name="oc_info" value="1"  />
			...
			<h4>Datos de instancia API</h4> 
			 <div class="col-lg-12">
			   <table class="table_form">
				<tbody>
				  <tr><th><strong>URL</strong></th><td><input type="text" class="inputPage col-lg-6"  id="url" name="url" value="<?php echo $oc_url; ?>" /></td></tr>
