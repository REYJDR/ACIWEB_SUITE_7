...
<div class="limiter">
		...
		<input type="hidden" id="NO_LINES" value="">
			<!--INI cabecera-->
			<div class="col-lg-12">
			    ...
			    <fieldset>
			        <div class="col-lg-12"> 
			           ...
			           <fieldset>
				           ...
				           <input class="inputPage col-lg-12"  id="ref" name="ref"  value="<?php echo $ref; ?>" readonly/>
			           </fieldset>
			         </div>
			          ...
			          <div class="col-lg-3">
			           <fieldset>
				           ...
				           <input  class="inputPage" id="date" name="date"  value="<?php echo $date; ?>" readonly/>
			           </fieldset>
			         </div>
		          ...
		          <div class="col-lg-2" >
			         <fieldset>
			           <p><strong>Entrega a:</strong></p>
			            <input class="inputPage col-lg-12" id="entrega" name="entrega"  value="<?php echo $entrega; ?>" />  
			         </fieldset>
			         </div>
			        ...
			        <div class="col-lg-2">
			         <fieldset>
			          <p><strong>No. PO: </strong></p>
			            <input  class="inputPage col-lg-12" id="nopo" name="nopo"  value="<?php echo $nopo; ?>"/>
			         </fieldset>
			        </div> 
			         ...
			         <fieldset>
			             <p><strong>Tipo de Licitacion</strong></p>
			                <input class="inputPage col-lg-12" id="tipo_licitacion" name="tipo_licitacion" value="<?php echo $tylici; ?>" /> 
			         </fieldset>
			         </div>
			           ...
			           <fieldset>
				           ...
				           <input class="inputPage col-lg-12"  id="customer" name="customer"  value="<?php echo $Cliente; ?>" readonly/>
			           </fieldset>
			         </div>
			         ...
			         <fieldset>
			             <p><strong>Terminos de pago</strong></p>
			               <input  class="inputPage col-lg-12" id="termino_pago" name="termino_pago" value="<?php echo $typago; ?>" readonly/>
			         </fieldset>
			         </div>
			         ...
			         <div class="col-lg-6" >
			           <fieldset>
			             <p><strong>Observaciones</strong></p>
			               <textarea class="textareaPage col-lg-12"  rows="2" id="observaciones" name="observaciones" ><?php echo $nota; ?></textarea> 
			         </fieldset> 
			         </div>
			         <div class="col-lg-6">
              ...
              foreach ($detail as $key => $value) {
              	...
              	$PRICE = $this->numberFormatPrecision($ORDER->{'Unit_Price'});
								echo  "<tr>
													...
													<td contenteditable id="desc'.$i.'" onkeyup="checkTblChar(this.id); checkLong(this.id,50); checkTblCharComa(this.id);" >'.$ORDER->{'Description'}."</td>
													<td>".$ORDER->{'Taxable'}."</td>
			...
			<div class="col-lg-5" >
			  <input class="inputPage col-lg-12"  style="text-align:right;" type="number"  step="0.01" id="subtotal" name="subtotal"  value="0.00" readonly />
			  <input class="inputPage col-lg-12"  style="text-align:right;" type="number"  step="0.01" id="tax" name="tax" value="0.00" readonly/> 
			  <input class="inputPage col-lg-12"  style="text-align:right;" type="number"  step="0.01" id="total" name="total" value="0.00" readonly />
			</div>
				...
				<div class='col-lg-4'>
					<div class="container-login100-form-btn">
								<button type="button" id="process" class="accept-form-btn" onclick="ShowOrderToCancel();" >
								<i class="fas fa-print"></i> <?PHP echo $BTN_Process1; ?>
								</button>
					</div>
				</div>
				<!--fin Button Process-->
