                ...
                <?php } ?>
                           ...
                           <?php  foreach ($ORDER as  $value) { 
                            ...
                            $table .= '<tr>
                               ...
                               <td width="15%" style="text-align: center; padding-right">'.number_format(numberFormatPrecision($libras,2),2).'</td>
                               <td width="15%" style="text-align: center; padding-right">'.numberFormatPrecision($unidades,2).'</td>
