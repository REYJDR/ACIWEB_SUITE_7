...
public function Init(){
     ...
     $res = $this->model->verify_session();
            ...
            if($res=='0'){
                ...
                require APP . 'view/modules/billing/BillingSales.php';
...
public function GenInvoice($id){
     ...
     $res = $this->model->verify_session();
            ...
            if($res=='0'){
                ...
                require APP . 'view/_templates/header.php';
                require APP . 'view/_templates/panel.php';
                require APP . 'view/modules/billing/BillGen.php';
                require APP . 'view/_templates/footer.php';
...
public function GetInvoiceNumber($ID){
  ...
  if (strpos($e, 'FE') !== false) {
    ...
    $docNo   = substr($e, 38, 48);
    $ptoFact = substr($e, 48 , 51);
    if( $ID == 'ACI-V-208691'){
...
//inserto informacion de SO en Sales para contabilizacion en PT
