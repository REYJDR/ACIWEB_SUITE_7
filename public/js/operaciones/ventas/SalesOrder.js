...
while(i <= cantLineas){
      ...
      "<td width='15%' class='rowtable_req' onkeypress='MSG_ERROR_RELEASE();' onkeyup='checkTblChar(this.id); checkLong(this.id,'50'); checkTblCharComa(this.id);' contenteditable id='nota"+i+"'  ></td>"+
